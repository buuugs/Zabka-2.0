<?php
   ...
   include_once SUB_DIR . 'assets/data/woa.txt';
...
<div class="col-12 mt-3 mb-2">
   ...
   <center><b>Warzywa i Owoce</b> </br> Zalogowano jako : <b> <?php Util::display($username); ?>  </b>
</center>
   </div>
</div>
        ...
        <a href="/straty/index"><i class="fa fa-arrow-left fa-2x" aria-hidden="true"></i></a>
          <center>
            ...
            <form method="post" action="">
              <?php
                foreach($bazawo as $item)
                {
                   echo '<label for="'. $item .'">'. $item  . ':</label></br>';
                   echo '<input type="number" step="0.001" id="formobject" name="'.$item.'" placeholder="0" autofocus="true"/><br />';
                }
                ?>
